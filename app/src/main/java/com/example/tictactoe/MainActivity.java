...
public class MainActivity extends AppCompatActivity {
    ...
    private void winningGame() {
        ...
        if((b1 == 1) && (b2 == 1) && (b3 == 1)){
            ...
            builder.setMessage("Player X Wins \n\nNow Turn is O").setCancelable(false).setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                @Override
        ...
        if((b2 == 1) && (b5 == 1) && (b8 == 1)){
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(this);
            builder.setMessage("Player O Wins \n\nNow Turn is X").setCancelable(false).setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int which) {
                    button1.setImageDrawable(null);
                    button2.setImageDrawable(null);
